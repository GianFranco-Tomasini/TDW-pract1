function cargarPrincipal(){
    ...
    if(!datos){
        datos = { 
            usuarios : [
                {nombre: "x", contraseña: "x"},
                {nombre: "y", contraseña: "y"},
                {nombre: "z", contraseña: "z"},
                ],
            personas:[
...
function onLogin(event, form){
    event.preventDefault();
    const user = form.userName.value;
    const pass = form.password.value;
    let datos = JSON.parse(window.localStorage.getItem("datos"));
    let usuario = buscarUsuario(datos, user, pass);
    if(usuario){
...
function buscarUsuario(datos, user, pass){
...
function crearFormularioLogin(){
    ...
    formulario.setAttribute("id", "login");
    formulario.setAttribute("onsubmit", "return onLogin(event, this);");
...
function cargarPagCreacion(){
    ...
    crearInput(formulario, "nombre", "Nombre", "text");
    crearInput(formulario, "fechai", "Fecha nacimiento", "date");
    crearInput(formulario, "fechaf", "Fecha defunción", "date");
    crearInput(formulario, "linkimg", "Link imagen", "url");
    crearInput(formulario, "linkwiki", "Link wiki", "url");
    switch(tipoElemento){
        case "producto":
